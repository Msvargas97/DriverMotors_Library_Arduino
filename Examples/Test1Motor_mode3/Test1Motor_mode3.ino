...
/*
  Ejemplo para el uso de la libreria Driver Motors Usando un solo motor y el modo 3 conexiones
...
//Instanciar Objeto
//                                    PWM Pin     Control pin INA ,INB          
DriverMotors motors((unsigned char []) {10},(unsigned char []) {13,5}, STOP_MODE);
